function F=ConesaKitaoKrueger2009_ReturnFn(l,kprime,k,eta,r,w,tau_k, tau_ss,ybar,tau_c,SS,chi,gamma_c,gamma_l,gamma,epsilon_j,alpha_i,I_j,A,alpha,delta, Tr_beq, tau_kappa0, tau_kappa1, tau_kappa2,Model_AltUtilityFn) %i
