function totalincometax=ConesaKitaoKrueger2009_TotalIncomeTaxRevenueFn(l,kprime,k,eta,r,tau_k,tau_ss,ybar,epsilon_j,alpha_i,I_j,A,alpha,delta, tau_kappa0, tau_kappa1, tau_kappa2,Tr_beq) %i
...
totalincometax=laborincometax+capitalincometax;
